...
continueRoutine = True
# update component parameters for each repeat
text_5.setText(textbase["Instructions"][language])
key_resp_6.keys = []
key_resp_6.rt = []
_key_resp_6_allKeys = []
# keep track of which components have finished
...
continueRoutine = True
# update component parameters for each repeat
text_10.setText(textbase["Instructions2"][language])
key_resp_10.keys = []
key_resp_10.rt = []
...
key_resp.rt = []
_key_resp_allKeys = []
text_2.setText(textbase["Hello_World"][language])
# keep track of which components have finished
...
key_resp_4.rt = []
_key_resp_4_allKeys = []
text_11.setText(textbase["Input"][language])
# keep track of which components have finished
...
key_resp_5.rt = []
_key_resp_5_allKeys = []
text_4.setText(textbase["Output"][language])
from psychopy.hardware import keyboard
from psychopy import core
...
continueRoutine = True
# update component parameters for each repeat
text_14.setText(textbase["TrainingSnippet"][language])
key_resp_12.keys = []
key_resp_12.rt = []
...
continueRoutine = True
# update component parameters for each repeat
text_3.setText(textbase["Crossexplain"][language])
key_resp_16.keys = []
key_resp_16.rt = []
...
continueRoutine = True
# update component parameters for each repeat
text.setText(textbase["Question"][language])
key_resp_14.keys = []
key_resp_14.rt = []
...
continueRoutine = True
# update component parameters for each repeat
text_6.setText(textbase["SyntaxInstruction"][language])
key_resp_7.keys = []
key_resp_7.rt = []
_key_resp_7_allKeys = []
# keep track of which components have finished
...
continueRoutine = True
# update component parameters for each repeat
text_7.setText(textbase["SampleSyntax"][language])
Pfeiltaste.keys = []
Pfeiltaste.rt = []
_Pfeiltaste_allKeys = []
weiter.keys = []
...
continueRoutine = True
# update component parameters for each repeat
overview.setText(textbase["Overview"][language])
key_resp_8.keys = []
key_resp_8.rt = []
_key_resp_8_allKeys = []
# keep track of which components have finished
...
continueRoutine = True
# update component parameters for each repeat
text_12.setText(textbase["DoNotMove"][language])
key_resp_19.keys = []
key_resp_19.rt = []
